        ...
        <div class="main_w3agile" style=" width: 1250px; height: 500px; padding: .3em;">
            ...
            <table style="border-spacing:4px; text-align:left; width: 100%;border-collapse: collapse;">
             ...
             <tbody>
              ...
              <a href="<?php echo e(action('ordersController@edit', $orders->id)); ?>"> <p style="margin-right: 10px">Editar</p> <img src="<?php echo e(URL::asset("/images/editorial-design.png")); ?>" style="top: 230px; left: 810px; height: 25px; width: 25px; border:none;"></a></td>
                <td >
