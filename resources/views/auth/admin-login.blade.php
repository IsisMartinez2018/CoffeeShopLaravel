...
<link href="{{url('//fonts.googleapis.com/css?family=Righteous')}}" rel="stylesheet">
<link href="{{url('//fonts.googleapis.com/css?family=Josefin+Sans:100,300,400,600,700')}}" rel="stylesheet">
				  ...
				  <li>
					<div class="banner-bottom-2">			  		
						<div class="about-midd-main">
							<img class="agile-img" src="{{url('/images/girl.png')}}" alt=" " class="img-responsive">
							<h4><img src="{{url('/images/eat.png')}}" style="height: 30px; width: 30px; border:none;">Coffee Shop<img src="{{url('/images/cup.png')}}" style="height: 30px; width: 30px; border:none;"></h4>
...
<label class="anim">
					...
					<div class="banner-bottom-2">			  		
						<div class="about-midd-main">
							<img class="agile-img" src="{{url('/images/girl2.jpg')}}" alt=" " class="img-responsive">
							<h4>Coffee <img src="{{url('/images/coffeecup2.png')}}" style="height: 40px; width: 40px; border:none; border-radius: none"> Shop</h4>
							<p>Online Orders</p>
						</div>
						<div class="new-account-form">
							<h2 class="heading-w3-agile">Login</h2>
				  ...
				  <li>
					<div class="banner-bottom-2">			  		
						<div class="about-midd-main">
							<img class="agile-img" src="{{url('/images/girl3.jpg')}}" alt=" " class="img-responsive">
							<h4><img src="{{url('/images/milk.png')}}" style="height: 30px; width: 30px; border:none; border-radius: none">Coffee Shop<img src="{{url('/images/coffees.png')}}" style="height: 30px; width: 30px; border:none; border-radius: none"></h4>
							<p>Online Orders</p>
						</div>
						<div class="new-account-form">
							<h2 class="heading-w3-agile">Login</h2>
